...
<script type="text/javascript">
	...
	if(window.top != window.self){ //我自己不在顶级窗口上的时候
		window.top.location = window.self.location;  //顶级窗口的地址发生改变
	}
	...
	function login(){
		...
		$.ajax({
			...
			data : {
				...
				"tenDaysAutoLogin" : tenDaysAutoLogin
			},
			beforeSend : function(){ 
			...
			<form class="form-horizontal" role="form">
				<div class="form-group form-group-lg">
					...
					<div class="checkbox"  style="position: relative;top: 30px; left: 10px;">
						<label>
							<input type="checkbox" id="tenDaysAutoLogin"> 十天内免登录
