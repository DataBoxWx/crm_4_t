		...
		<%
			...
			for(int i=0;i<stageList.size();i++){
				if(i == currentStageIndex){
					//正在进行
		%>
		<span class="glyphicon glyphicon-map-marker mystage" data-toggle="popover" data-placement="bottom" data-content="<%=stageList.get(i) %>" style="color: #90F790;"></span>
		-----------
		<%
				}else if(i > currentStageIndex){
					//未进行
		%>
		<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="<%=stageList.get(i) %>" style="color: black;"></span>
		-----------
		<%
				}else{
					//已完成
		%>
		<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="<%=stageList.get(i) %>" style="color: #90F790;"></span>
		-----------
		<%
				}
			}
