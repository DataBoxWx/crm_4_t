...
<script type="text/javascript">
	$(function(){
		...
		$("#convertBtn").click(function(){
			//传统请求
			if(window.confirm("您确定要转换该线索吗，转换之后不可恢复！")){
				if($("#isCreateTransaction").prop("checked")){
					//提交表单
					$("#tranForm").submit();
				}else{
					document.location.href = "workbench/clue/convert.do?clueId=${param.clueId}";	
				}
			}
		});
	});
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post" >
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="tradeName" name="transactionName" value="${param.company }-">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" name="activityId" value="819cbaf7f3f74883a108913a903a780d" class="form-control" id="activity" placeholder="点击上面搜索" readonly>
		  </div>
		</form>
