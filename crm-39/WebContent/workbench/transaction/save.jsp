...
<body>
	...
	<%--
		${user}和${"user"}有什么区别？
			第一个：从域中取出name="user"的数据     request.setAttribute("user" , xxx);
			第二个：直接将"user"看做普通字符串输出到浏览器
	--%>
	<form id="tranForm" action="workbench/transaction/save.do" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		<div class="form-group">
			<label for="create-transactionOwner" class="col-sm-2 control-label">所有者<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="owner" name="owner">
				<c:forEach items="${userList }" var="userObj">
				<option value="${userObj.id}" ${user.id eq userObj.id ? "selected" : ""}>${userObj.name }</option>
				</c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="activityId" name="activityId" value="aa1198a587a944ffa2829b889ed453e2">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="contactsId" name="contactsId" value="53aefd95f0e34b238f9dd6a7a4055c6f">
			</div>
		</div>
